...
- 📊 **EASP APP** — Flutter field app for utility meter management: QR-scan electric, water, gas & thermal meters, record readings with offline sync, and export PDF/Excel reports (Firebase · BLoC).
